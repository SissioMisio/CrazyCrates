...
public class CommandKeys implements SettingsHolder {
    ...
    public static final Property<String> reloaded_plugin = newProperty("command.reload.completed", "{prefix}<cyan>You have reloaded the Config and Data Files.");
    ...
    public static final Property<List<String>> admin_help = newListProperty("command.admin-help", List.of(
            ...
            "<gold>/cc set1/set2 <gray>- <yellow>Sets position <red>#1 <yellow>or <red>#2 for when making a new schematic for QuadCrates.",
